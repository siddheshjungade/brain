...
# 3️. Iterating using `for` on fun that yield value
...
# 4️. Generator Expression (Lazy comprehension)
...
# 7️. Generator Pipeline (chaining)
...
# 9️. Two-way Generator using `send()`
