...
# 1️. What is a Decorator (mental model)
...
# 3️. Using `@` syntax (same thing, cleaner)
...
# 4️. Decorator with arguments in function
...
# 5️. Why `functools.wraps` is important
...
# 6️. Real-world decorator: logging
...
# 7️. Auth + Logging decorator (practical example)
...
# 8️. Decorator with parameters (advanced)
...
# 9️. Multiple decorators (stacking)
...
# 10. Where decorators are used in real world
...
# 1️1. Simple timing decorator (real use)
